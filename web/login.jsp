...
<div class="wrapper container ">
    <div class=" bordeneon colorfondo p-1 p-lg-5 mt-5">
        <h2 class="m-5 titulo border-bottom">Login</h2>
        ...
        <!--OPCIÓN DE REGISTRARSE POR SI NO SE DISPONE DE CUNETA-->
        <div class="text-light">
            <div class="d-flex justify-content-center links">
                No tienes una cuenta? <a href="registro.jsp" class="ps-1"> Registrate!</a>
            </div>
        </div>
    </div>
